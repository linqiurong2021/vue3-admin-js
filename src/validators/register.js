...
// 密码校验
export async function checkPassword (rule, value, callback) {
  if (!value) {
...
// 确认密码校验
export async function checkConfirm (rule, value, callback) {
  if (!value) {
...
// 校验码校验
export async function checkCode (rule, value, callback) {
  if (!value) {
