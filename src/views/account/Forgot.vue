    ...
    <div class="form-wrap">
      <a-form :model="form" @finish="register" :rules="rules">
        <a-form-item name="username">
          ...
          <a-input type="text" :value="form.username" autocomplete="off"/>
        </a-form-item>
        <a-form-item name="password">
          <label class="color-white">密码</label>
          <a-input type="password" :value="form.password" autocomplete="off"/>
        </a-form-item>
       <a-form-item name="confirm">
          <label class="color-white">确认密码</label>
          <a-input type="password" :value="form.confirm" autocomplete="off"/>
        </a-form-item>
        ...
        <a-form-item>
          <a-button type="primary" html-type="submit" :span="12" >确认</a-button>
        </a-form-item>
      </a-form>
      <div class="text-center font-size-12">
        <router-link to="/register" class="color-white">注册</router-link> | <router-link to="/login" class="color-white">登录</router-link>
      </div>
    </div>
  </div>
</template>
